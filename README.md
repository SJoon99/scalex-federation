...
POC namespace도 B/C Infra가 공통 `workload-namespace` app으로 소유하며,
Federation의 Karmada source namespace는 default auto-propagation을 건너뛴다.
...
- Infra dependency가 있는 workload namespace의 member lifecycle도 대상 `*-k8s` repository가 소유한다.
